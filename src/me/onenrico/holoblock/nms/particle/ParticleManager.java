...
public class ParticleManager {
	...
	public static void setup() { 
		try { 
			...
			packetConstructor = packetClass.getConstructor(newEnum,boolean.class, 
	...
	public static void sendParticles(Player player, String particle, Location loc, 
			...
			float data, int amount)
	{
		...
		try { 
			...
			Object packet = packetConstructor.newInstance(enumParticle,false, x, y, z, 
