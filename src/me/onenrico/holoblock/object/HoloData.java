...
public class HoloData {
	...
	public void updatePerm() {
		...
		allowColor =PermissionUT.has(
				ofp, 
				"holoblock.use.color", world);
		allowPlaceholders =PermissionUT.has(
				ofp, 
				"holoblock.use.placeholders", world);
		allowItemLine =PermissionUT.has(
				ofp, 
				"holoblock.use.itemline", world);
		allowCustomSkin =PermissionUT.has(
				ofp, 
